      ...
      <head>
        <script
          ...
          dangerouslySetInnerHTML={{ __html: JSON.stringify({
            ...
            knowsAbout: ["AI Automation", "AI Integration", "Agentic AI", "Generative AI", "GenAI Services", "Vibe Coding", "AI-enabled Apps", "WhatsApp Bots", "RAG Systems", "Flutter Development", "SaaS Platforms", "Business Automation", "AI Consulting", "LLM Development", "Conversational AI", "AI Copilots", "ChatGPT Integration", "Enterprise AI Solutions"],
            hasOfferCatalog: {
              "@type": "OfferCatalog",
