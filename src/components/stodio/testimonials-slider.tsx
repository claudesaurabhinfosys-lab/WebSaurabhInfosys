...
/* Client half of the testimonials block. The list arrives as a prop from the
   server wrapper (testimonials-section.tsx) so data.ts stays server-side. */
export default function TestimonialsSlider({ testimonials: TESTIMONIALS }: { testimonials: Testimonial[] }) {
