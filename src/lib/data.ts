...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  { id: 21, slug: "volest",              title: "Volest",               category: "Fintech",    description: "Investment portfolio tracker with real-time market data, asset allocation analytics, and performance reports.", tech: ["React", "Node.js", "Chart.js"],       highlights: ["Multi-asset portfolio tracking across stocks, MFs, and crypto", "Real-time market data with live P&L calculation", "Asset allocation charts with rebalancing suggestions", "Performance vs benchmark comparison"], images: ["/images/work/volest/01.webp"] },
  { id: 22, slug: "retirement-planning", title: "Retirement Planning",  category: "Fintech",    description: "Retirement savings calculator and financial planning tool with scenario modelling and SIP recommendations.", tech: ["React", "Node.js", "PostgreSQL"],     highlights: ["Inflation-adjusted retirement corpus calculator", "SIP and lump sum scenario comparison modelling", "Visual retirement timeline with milestone markers", "Recommended SIP amounts based on current savings gap"], images: ["/images/work/retirement-planning/01.webp"] },
  { id: 23, slug: "aces",                title: "ACES",                 category: "Custom Dev", description: "Industrial machine maintenance and equipment management platform with checklist history, operator manuals, and risk assessment workflows.", tech: ["Next.js", "PostgreSQL", "REST API"],  highlights: ["Machine tagging and equipment profile tracking", "Pre-operation checklists and inspection history", "Maintenance records and scheduled servicing logs", "Digital operator manuals and risk assessment workflows"], images: ["/images/work/aces/01.webp"] },
  { id: 24, slug: "subrate",             title: "Subrate",              category: "Education",  description: "Online learning and micro-task platform where learners earn rewards as they complete daily lessons, social tasks, and educational modules.", tech: ["Flutter", "Node.js", "Firebase"], highlights: ["Daily lesson feed with interactive video learning", "Task-based earning engine with automated wallet payouts", "Multi-tier task verification and completion tracking", "Gamified progress with earnings analytics and milestones"], images: ["/images/work/subrate/01.webp"] },
  ...
  { id: 54, slug: "tap-to-share",        title: "Tap To Share",         category: "Custom Dev",  description: "Digital business card and bio-link profile platform with customizable links, viewer analytics, and instant NFC/QR sharing.", tech: ["React Native", "Node.js", "Firebase"], highlights: ["Custom digital bio page with links, photos, and socials", "Real-time link click and visitor analytics", "NFC tap and QR code instant profile sharing", "Customizable cover themes and personal branding"], images: ["/images/work/tap-to-share/01.webp"] },
