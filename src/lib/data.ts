...
export const PORTFOLIO_PROJECTS: PortfolioProject[] = [
  ...
  { id: 8,  slug: "sleepz",              title: "Sleepz",               category: "Health",     description: "Sleep quality tracking and improvement app with AI-powered coaching, sleep score analysis, and habit nudges.", tech: ["Flutter", "Firebase", "ML Kit"],      highlights: ["AI sleep coaching personalised to detected sleep patterns", "Sleep score with nightly trend analysis", "Habit tracking with smart nudges for sleep hygiene", "Integration with wearables for automatic sleep detection"], images: ["/images/work/sleepz/01.webp", "/images/work/sleepz/02.webp", "/images/work/sleepz/03.webp", "/images/work/sleepz/04.webp"] },
  ...
  { id: 12, slug: "quick-delivery",      title: "Quick Delivery",       category: "Transport",  description: "On-demand last-mile delivery platform with real-time tracking, driver app, and customer notifications.", tech: ["Flutter", "Node.js", "Google Maps"],  highlights: ["Live order tracking on an interactive map", "Dedicated driver app with optimised route suggestions", "Push notifications at every delivery milestone", "Merchant dashboard for order and driver management"], images: ["/images/work/quick-delivery/01.webp", "/images/work/quick-delivery/02.webp", "/images/work/quick-delivery/03.webp", "/images/work/quick-delivery/04.webp"] },
  ...
  { id: 16, slug: "barber-plus",         title: "Barber Plus",          category: "Gig",        description: "Record keeping and financial management app for barber shops — tracking barber transactions, service packages, commissions, and member deposits.", tech: ["Flutter", "Firebase", "REST API"], highlights: ["Barber transaction logs with deposit and withdrawal tracking", "Package management for haircuts, beard trims, and spa combos", "E-wallet balance and commission breakdown for barbers and shop admin", "Monthly revenue trends, expense overviews, and member history"], images: ["/images/work/barber-plus/01.webp", "/images/work/barber-plus/02.webp", "/images/work/barber-plus/03.webp", "/images/work/barber-plus/04.webp"] },
  ...
  { id: 25, slug: "review",              title: "Review",               category: "Custom Dev", description: "Peer and contact review app allowing users to leave verified reviews, rate interactions, earn coupon rewards, and manage their reputation score.", tech: ["React Native", "Node.js", "Firebase"], highlights: ["Contact-based review system with star ratings", "Reward coupons and redemption points for helpful reviews", "User reputation score and verified feedback history", "Special message requests and notification delivery"], images: ["/images/work/review/01.webp", "/images/work/review/02.webp", "/images/work/review/03.webp", "/images/work/review/04.webp"] },
  ...
  { id: 28, slug: "formwork",            title: "Formwork",             category: "Custom Dev",  description: "Construction management and field reporting software with RFI workflows, technical submissions, drawings, RAMS, and site daily logs.", overview: "Formwork is a comprehensive construction management and field reporting application built to bridge site teams and back-office operations in real time. It unifies Request for Information (RFI) workflows, technical submissions, drawing registers, health and safety compliance (RAMS), non-conformance reporting, and digital site daily logs into a synchronized multi-platform ecosystem across web and mobile devices.", tech: ["Flutter", "Node.js", "PostgreSQL"], highlights: ["RFI (Request for Information) creation, assignment, and status tracking", "Technical submissions, drawing registers, and induction management", "RAMS (Risk Assessment & Method Statement) and non-conformance logs", "Site daily logs, snagging lists, and photo attachment workflows"], images: ["/images/work/formwork/01.webp", "/images/work/formwork/02.webp", "/images/work/formwork/03.webp", "/images/work/formwork/04.webp"] },
  { id: 29, slug: "doodler",             title: "Doodler",              category: "Custom Dev",  description: "Creative digital drawing and sketching application with layers, brushes, and cloud sync for artists.", tech: ["Flutter", "Firebase", "Canvas API"],   highlights: ["Multi-layer canvas with blend modes and opacity control", "Custom brush library with pressure sensitivity support", "Cloud sync to access artwork across all devices", "Export in PNG, SVG, and PDF with resolution options"], images: ["/images/work/doodler/01.webp", "/images/work/doodler/02.webp", "/images/work/doodler/03.webp", "/images/work/doodler/04.webp"] },
...
export const TESTIMONIALS = [
  ...
  /* Google reviews, quoted as written. "…" marks where a long review is
     shortened to fit the card. */
  {
    name: "Said El Maliji",
    role: "Google review",
    text: "Choosing the right partner is not something you should underestimate because your credibility is at stake. They helped with my Flutter App development. They completed the MVP as per requirements in an excellent way and are always ready to provide help after this phase is completed. … They are hyper reactive, communication is very easy and they are fully scalable. Highly recommend.",
    rating: 5,
  },
  {
    name: "Juan Pablo Gonzalez",
    role: "Google review",
    text: "Their commitment to maintaining high standards of quality is truly commendable. Their efficiency in operations and speed in execution is notable; they are able to deliver results swiftly without compromising on the quality. … It's rare to find a combination of these attributes, making this company distinctively impressive in the industry.",
    rating: 5,
  },
  {
    name: "Harral Aria",
    role: "Google review",
    text: "Their attention to user-friendly design impressed me. They completed the project on time and maintained excellent communication throughout. Saurabh Infosys is a reliable partner for turning your vision into reality and navigating the app store release process. Highly recommended!",
    rating: 5,
  },
  {
    name: "Akintoye Ayomide",
    role: "Google review",
    text: "I had the pleasure of working with Saurabh Infosys to bring my mobile app idea to life, and I couldn't be happier with the outcome. They always delivered on time, their prices were fair and transparent, and there were no hidden surprises. Their post-installation support has been exceptional.",
    rating: 5,
  },
  {
    name: "Sasa Sasasa",
    role: "Google review",
    text: "You've taken my ideas and turned them into a reality with such finesse. The smooth operation and user-friendly design are a true reflection of your talent and dedication. I'm absolutely thrilled with the results!",
    rating: 5,
  },
  {
    name: "Rakesh Raja",
    role: "Google review",
    text: "The application was impeccably executed according to the provided specifications. We have been utilizing this application for the past year, and it continues to perform exceptionally well. It played a pivotal role in enhancing our service offerings, contributing significantly to the expansion of our business.",
    rating: 5,
  },
  {
    name: "Mandi Eder",
    role: "Google review",
    text: "The company was trustworthy and very communicative. They delivered exactly what they promised.",
    rating: 5,
  },
  {
    name: "Gurish IMA",
    role: "Google review",
    text: "Great experience working with Saurabh Infosys, one of the best web and app development companies in Ahmedabad, Gujarat. Good service and timely completion of work. Thank you.",
    rating: 5,
  },
  {
    name: "Vijay Singh Bohra",
    role: "Google review",
    text: "Arun and his team took complete ownership of the activities and really became part of our team. They work as true partners and not just vendors.",
    rating: 5,
  },
  {
    name: "Sudhakar Jadhav",
    role: "CEO, Axolotls Innovative Technologies",
    text: "I really appreciated their work and style. They are good in nature and also understand all requirements properly. So we are happy to work with them.",
    rating: 5,
  },
];
