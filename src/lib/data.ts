...
/* ============================================================
   Country landing pages — /country/[slug]

   One entry per market we sell into. The page shape is fixed
   (home-02: hero-v2, services-v6, about-v4, work-v3, process-v3,
   testimonials-v1, blog-v5, faq, inquiry), so adding a market means
   adding an entry here — no new route, no new components.

   Every client named below is a real, live project. The `result`
   lines are what we can stand behind; nothing here is a projection.
   ============================================================ */
...
export const COUNTRY_SLUGS = Object.keys(COUNTRY_PAGES);
